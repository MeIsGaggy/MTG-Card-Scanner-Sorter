...
STEADY_RELAX_FRAMES  = _get("STEADY_RELAX_FRAMES", 6, int)
STEADY_FORCE_CAPTURE_S = _get("STEADY_FORCE_CAPTURE_S", 12.0, float)
...
STREAM_FPS          = _get("STREAM_FPS", 30, int)
...
# ---- Added by settings sync ----
TRACK_ALPHA = 0.35
TRACK_BETA = 0.15
TRACK_DEADBAND_PX = 2.5
LOCK_IOU_THRESH = 0.55
ACQUIRE_FRAMES = 6
DROP_MISS_FRAMES = 10
PREDICT_HOLD = 8
STEADY_SPEED_PX = 0.6
WARP_EXPAND_PCT = 0.01
WARP_CROP_PCT = 0.0
DETECT_MAX_FPS = 30
APPEARANCE_ALIGN_ENABLE = True
APPEARANCE_AB_STRENGTH = 0.55
APPEARANCE_SAT_STRENGTH = 0.65
APPEARANCE_GAMMA_CLAMP = (0.65, 1.6)
TONE_ALIGN_ENABLE = False
